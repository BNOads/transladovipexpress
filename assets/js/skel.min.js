...
!function(e){skel.breakpoints({xlarge:"(max-width: 1680px)",large:"(max-width: 1280px)",medium:"(max-width: 980px)",small:"(max-width: 736px)",xsmall:"(max-width: 480px)"}),e(function(){var a=e(window),i=e("body");i.addClass("is-loading"),a.on("load",function(){window.setTimeout(function(){i.removeClass("is-loading")},100)}),e("form").placeholder(),skel.on("+medium -medium",function(){e.prioritize(".important\\28 medium\\29",skel.breakpoint("medium").active)}),e('<a href="#navPanel" title="Barras" class="navPanelToggle"></a>').appendTo(i),e('<div id="navPanel">'+e("#nav").html()+'<a href="#navPanel" class="close"></a></div>').appendTo(i).panel({delay:500,hideOnClick:!0,hideOnSwipe:!0,resetScroll:!0,resetForms:!0,side:"left"}),"wp"==skel.vars.os&&skel.vars.osVersion<10&&e("#navPanel").css("transition","none")})}(jQuery);
/*var Tawk_API=Tawk_API||{},Tawk_LoadStart=new Date;!function(){var e=document.createElement("script"),t=document.getElementsByTagName("script")[0];e.async=!0,e.src="https://embed.tawk.to/5cb35bd0d6e05b735b428283/default",e.charset="UTF-8",e.setAttribute("crossorigin","*"),t.parentNode.insertBefore(e,t)}();*/
